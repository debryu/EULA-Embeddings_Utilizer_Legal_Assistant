...
bert_parameters = bertMLM.parameters()
...
for i in range(iterations):
    for batch in tqdm(dataset_train):
        ...
        if(epoch % partial_save_every == 0):
            torch.save(bertMLM.state_dict(), save_path + f'bertMLM_partial_epoch.pth')
        epoch += 1
    ...
    torch.save(bertMLM.state_dict(), save_path + f'bertMLM_epoch{i}.pth')
